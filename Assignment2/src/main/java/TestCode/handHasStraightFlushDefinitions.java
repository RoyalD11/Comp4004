...
public class handHasStraightFlushDefinitions {

	ArrayList<Card> cards = new ArrayList<Card>();

	@Given("^Hand has Straight Flush in random order$")
	public void hand_has_Straight_Flush_in_random_order(DataTable table){
		System.out.println("\n------Straight Flush-------");
	...
	public void hand_has_Straight_Flush() {
		...
		for(int i = 0; i<5; i++) {
			assertTrue(Hand.STRAIGHT_FLUSH == weight);
		...
		System.out.println("------Straight Flush Test Finished-------\n\n");
	}
