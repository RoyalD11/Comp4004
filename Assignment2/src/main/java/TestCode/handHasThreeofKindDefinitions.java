...
public class handHasThreeofKindDefinitions {
	
	ArrayList<Card> cards = new ArrayList<Card>();

	@Given("^Hand has Three of a Kind in random order$")
	public void hand_has_Three_of_a_Kind_in_random_order(DataTable table) {
		System.out.println("\n------Three of a Kind-------");
	...
	public void hand_has_Three_of_a_Kind() {
		...
		for(int i = 0; i<5; i++) {
			assertTrue(Hand.THREE_OF_A_KIND == weight);
		...
		System.out.println("------Three of a Kind Test Finished-------\n\n");
	}
