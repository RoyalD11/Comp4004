...
public class handHasRoyalFlushDefinitions {
	
	ArrayList<Card> cards = new ArrayList<Card>();

	//Random Order
	@Given("^Hand has Royal Flush in random order$")
	public void hand_has_Royal_Flush_in_random_order(DataTable table){
	...
	@Then("^Hand has Royal Flush$")
	public void hand_has_Royal_Flush(){
		...
		for(int i = 0; i<5; i++) {
			assertTrue(Hand.ROYAL_FLUSH == weight);
		...
		System.out.println("------Royal Flush Test Finished-------\n\n");
	}
}
