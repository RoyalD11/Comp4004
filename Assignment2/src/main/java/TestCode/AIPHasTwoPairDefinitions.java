...
public class AIPHasTwoPairDefinitions {
	...
	public void aip_is_one_card_away_from_a_two_pair(DataTable table) {
		
		System.out.println("---------AIP is has Two Pair, Exchanges a Card and Wins---------");
		game = new Game();
	...
	@Given("^AIP exchanges the odd card \"([^\"]*)\"$")
	public void aip_exchanges_the_odd_card(String cardToAdd) {
		//Makes Two Players
	...
	public void aip_wins_with_a_full_house() {
