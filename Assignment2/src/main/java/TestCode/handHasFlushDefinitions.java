...
public class handHasFlushDefinitions {
	
	ArrayList<Card> cards = new ArrayList<Card>();

	@Given("^Hand has Flush in random order$")
	public void hand_has_Flush_in_random_order(DataTable table) {
		System.out.println("\n------Flush-------");
	...
	public void hand_has_Flush() {
		...
		System.out.println("------Flush Test Finished-------\n\n");
	}
