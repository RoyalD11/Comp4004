...
public class handHasStraightDefinitions {
	
	ArrayList<Card> cards = new ArrayList<Card>();

	@Given("^Hand has Straight in random order$")
	public void hand_has_Straight_in_random_order(DataTable table) {
	...
	public void hand_has_Straight() {
		...
		for(int i = 0; i<5; i++) {
			assertTrue(Hand.STRAIGHT == weight);
		...
		System.out.println("------Straight Test Finished-------\n\n");
	}
